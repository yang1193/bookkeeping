...
//      向typetb表当中插入元素
        ...
        db.execSQL(sql,new Object[]{"Commodity", R.mipmap.ic_riyongpin,R.mipmap.ic_riyongpin_fs,0});
        db.execSQL(sql,new Object[]{"Entertain", R.mipmap.ic_yule,R.mipmap.ic_yule_fs,0});
        ...
        db.execSQL(sql,new Object[]{"Renting", R.mipmap.ic_zhufang,R.mipmap.ic_zhufang_fs,0});
        db.execSQL(sql,new Object[]{"Share Bills", R.mipmap.ic_shuidianfei,R.mipmap.ic_shuidianfei_fs,0});
        db.execSQL(sql,new Object[]{"Comm", R.mipmap.ic_tongxun,R.mipmap.ic_tongxun_fs,0});
        db.execSQL(sql,new Object[]{"Relation", R.mipmap.ic_renqingwanglai,R.mipmap.ic_renqingwanglai_fs,0});
        ...
        db.execSQL(sql,new Object[]{"Debts", R.mipmap.in_shouzhai,R.mipmap.in_shouzhai_fs,1});
        db.execSQL(sql,new Object[]{"Interests", R.mipmap.in_lixifuji,R.mipmap.in_lixifuji_fs,1});
        db.execSQL(sql,new Object[]{"Investment", R.mipmap.in_touzi,R.mipmap.in_touzi_fs,1});
        db.execSQL(sql,new Object[]{"2nd-Hand", R.mipmap.in_ershoushebei,R.mipmap.in_ershoushebei_fs,1});
        db.execSQL(sql,new Object[]{"bonanza", R.mipmap.in_yiwai,R.mipmap.in_yiwai_fs,1});
    }
