...
import com.hui.tianyi.adapter.ChartVPAdapter;
import com.hui.tianyi.db.DBManager;
import com.hui.tianyi.frag_chart.IncomChartFragment;
import com.hui.tianyi.frag_chart.OutcomChartFragment;
import com.hui.tianyi.utils.CalendarDialog;
...
//        将Fragment加载到Acitivy当中
    ...
    private void initStatistics(int year, int month) {
        ...
        dateTv.setText(year+"/"+month+"monthly bills");
        inTv.setText("Total: "+incountItemOneMonth+"#incomes, $ "+inMoneyOneMonth);
        outTv.setText("Total: "+outcountItemOneMonth+"#outcomes, $ "+outMoneyOneMonth);
